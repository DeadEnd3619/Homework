class Contacts:
    def __init__(self, first_name, last_name, home_phone, cell_phone, email, notes, affiliation):
    ...
    def __str__(self):
        return f'firstname:{self.first_name}, lastname:{self.last_name}, homephone:{self.home_phone}, cellphone:{self.cell_phone}, email:{self.email}, notes:{self.notes}, affiliation:{self.affiliation}'


contact_data = [{"id":1,"first_name":"Tamara","last_name":"Dowrey","email":"tdowrey0@dell.com","home_phone":"237-668-3190","cell_phone":"891-212-2704"},
...
nickname_data =[{"nick_names":"svanhault0"},
...
def Nick_name_thing():
    x = 0
    while x < len(nickname_data):
        nicknames.append(nickname_data[x]['nick_names'])
        x += 1
...
for data in contact_data:
    temp_contact = Contacts(data['first_name'], data['last_name'], data['home_phone'], data['cell_phone'], data['email'], data['notes'], data['affiliation'])
    contact.append(temp_contact)
